  ...
  async function editDataFun() {
    ...
    try {
      const updatedData = await axios.post(
        `http://localhost:8080/backend/update-data?s_no=${selectedRows[0]?.Sl_No}&invoice_currency=${editData.invoice_currency}&cust_payment_terms=${editData.cust_payment_terms}`
      );
      ...
      >
        <Box className="modal">
          ...
          <div className="modal-actions">
            <Button variant="outlined" onClick={editDataFun}>
              EDIT
            </Button>
