        ...
        <Box className="modal1">
          ...
          <div className="textfield1">
            <TextField
              ...
              size="small"
              onChange={(e) => {
                setData({ ...data, baseline_create_date: e.target.value });
              }}
            />
            <TextField
              id="filled-basic"
